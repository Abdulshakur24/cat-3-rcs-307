...
List<ShoppingCartItem> items;
     ...
     * the designated deliverycharge and sets the <code>total</code> instance variable
     * with the result.
     *
     * @param deliverycharge the designated surcharge for all orders
     * @see ShoppingCartItem
     */
    public synchronized void calculateTotal(String deliverycharge) {

        double amount = 0;

        // cast delivery charge as double
        double del = Double.parseDouble(deliverycharge);
